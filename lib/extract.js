...
export class Extractor {
  ...
  /**
   * Call Gemini API for extraction (REST API)
   */
  ...
  async extractIntake(rawText) {
    ...
    this.log(`  Client: ${intake.prepared_for.account_name}`);
    this.log(`  Workflow: ${intake.section_a_workflow_definition.q01_workflow_name}`);
